...
2. The version of Microsoft Excel on your Computer system should be Microsoft Office Excel 2010 and above, if you plan to use Excel to enter data first and then import the same in the Tool. If you can import data in csv format from another accounting software, as given along with Tool in the Zip file of Tool, you do not need Excel. 
