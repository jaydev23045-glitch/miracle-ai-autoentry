...
print("Checking native Miracle BR transactions for T40F09...")
count = 0
for r41 in t41:
    if dbf.is_deleted(r41): continue
    if r41['FIELD98'] == 'BR' and r41['FIELD17'] != 'U0000000':
        vid = str(r41['FIELD01']).strip()
        for r40 in t40:
            if not dbf.is_deleted(r40) and str(r40['T40F01']).strip() == vid:
                print(f"Native BR T40F09: {repr(r40['T40F09'])}, T40F02: {repr(r40['T40F02'])}")
                count += 1
                break
    if count >= 5: break
